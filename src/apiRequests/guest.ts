...
import { GuestCreateOrdersBodyType, GuestCreateOrdersResType, GuestLoginBodyType, GuestLoginResType } from "@/schemaValidations/guest.schema";
import { GuestLoginRes } from './../schemaValidations/guest.schema';
...
const guestApiRequest = {
    ...
    sLogout:(body:LogoutBodyType & {accessToken:string})=> http.post('/guest/auth/logout', {refreshToken:body.refreshToken},{
        headers:{
