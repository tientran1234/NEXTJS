...
export default function EditTable({
  ...
  const {data,refetch}=useGetTableQuery({id:id as number,enabled:Boolean(id)})
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form {...form}>
          <form noValidate className='grid auto-rows-max items-start gap-4 md:gap-8' id='edit-table-form' onSubmit={form.handleSubmit(onSubmit)} onReset={reset}>
